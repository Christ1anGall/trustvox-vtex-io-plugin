export const setProduct = ({
  ...
  if (sellers) window._trustvox.push(['_sellers', sellers])

  if (department_id)
    window._trustvox.push([
      '_productExtraAttributes',
      { department_id: department_id },
    ])

  if (gtin) _trustvox.push(['_productGtins', ['gtin', gtin]])

  if (ean) _trustvox.push(['_productEans', ['ean', ean]])
...
export const injectWidgetScripts = () => {
  ...
  // All scripts
  const scriptTags = [
    window.appsetting_trustvox_staging === 'true'
